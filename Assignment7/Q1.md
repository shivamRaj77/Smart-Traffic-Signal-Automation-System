...
**Implemented in:**
- `smart_traffic/services/auth_service.py`
...
- Login page sends credentials to API:  
  - `traffic_frontend/src/pages/LoginPage.jsx`  
  - API route: `smart_traffic/routes/auth.py`  
- Registration page creates account:  
  - `traffic_frontend/src/pages/RegisterPage.jsx`  
- Frontend stores token and decodes role for route protection:  
  - `traffic_frontend/src/context/AuthContext.jsx`  
  - `traffic_frontend/src/App.jsx`  
...
**Implemented in:**
- `smart_traffic/services/traffic_service.py`
...
- Dashboard Run Simulation action:  
  - `traffic_frontend/src/pages/DashboardPage.jsx`  
- Detailed Simulation page Run Simulation action:  
  - `traffic_frontend/src/pages/SimulationPage.jsx`  
- API endpoint handling simulation request:  
  - `smart_traffic/routes/simulate.py`  
...
- Override model support:  
  - `smart_traffic/models/override.py`  
...
- Override creation and listing UI:  
  - `traffic_frontend/src/pages/OverridesPage.jsx`  
- API routes for overrides:  
  - `smart_traffic/routes/admin.py`  
...
**Presentation layer interaction:**
- Logs page:  
  - `traffic_frontend/src/pages/LogsPage.jsx`  
- Users page:  
  - `traffic_frontend/src/pages/UsersPage.jsx`  
- Admin navigation visibility based on role:  
  - `traffic_frontend/src/components/Sidebar.jsx`  
...
2. Frontend sends POST request using API client:  
   - `traffic_frontend/src/lib/api.js`  
